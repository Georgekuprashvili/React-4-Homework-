...
import photo4 from '../../assets/fire.svg'
import photo5 from '../../assets/wheat.svg'
import photo6 from '../../assets/leaf.svg'
...
function Contanier() {
    return (
        <>
<Card food = {photo1} name= 'Pepperoni Pizza' photo1 = {photo6} photo2 = {photo4} photo3 = {photo5}
...
<Card food = {photo2} name= 'Tortellini' photo1 = {photo6} photo2 = {photo4} photo3 = {photo5}
...
<Card food = {photo3} name= 'Strawberry Cake' photo1 = {photo6} photo2 = {photo4} photo3 = {photo5}
